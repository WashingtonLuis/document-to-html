...
function manual(str) {
	...
	text = text
		.replace(/<(\w) >/g, "<$1>")
		.replace(/<p> ?(<b>) ?/gi, "<p>$1")
		.replace(/<(?!b)([\w]+)>\s*(?:<b>\s*)?(Atividades? Resolvidas?|Atividades de sala|Atividade de sala|Resolução de problemas?|Mão na massa|Vamos pesquisar|Cinefórum|Visita técnica|Ponto de partida|Conectando ideias|Exercícios de fixação|Saiba mais|CNEC virtual|Texto e Contexto|Dialogando)(?:\s*<\/b>)?\s*<\/\1>/gi, "<hr>\n<h5><b>$2</b></h5><br>")
