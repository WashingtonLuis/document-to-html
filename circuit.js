...
function padronizaCircuit(text) {
	text = text
		...
		.replace(/(Rua Elpenor Marquez da Silva\t\d+)\tRua Dois/gi, '$1')
...
function corrigirPalavras(texto) {
	const regras = [
		...
		{ correto: 'conveniência', base: 'conveniência' },
		{ correto: 'borracharia', base: 'borracharia' },
		{ correto: 'Joaquim', base: 'Joaquim' },
		{ correto: 'comércio', base: 'comércio' },
		{ correto: 'macarrão', base: 'macarrão' },
		{ correto: 'Teixeira', base: 'Teixeira' },
		{ correto: 'Helena', base: 'Helena' },
		{ correto: 'dentista', base: 'dentista' },
		{ correto: 'Bárbara', base: 'Bárbara' },
		{ correto: 'cabeleireiro', base: 'cabeleireiro' },
		{ correto: 'barbearia', base: 'barbearia' },
		{ correto: 'Emerenciano', base: 'Emerenciano' },
		{ correto: 'bar', base: 'bar' },
		{ correto: 'Esplanada', base: 'Esplanada' },
		{ correto: 'Amui', base: 'Amui' },
		{ correto: 'Glória', base: 'Glória' },
		{ correto: 'Antônia', base: 'Antônia' },
		{ correto: 'Mangueiras', base: 'Mangueiras' },
		...
		{ correto: 'Reis', base: 'Reis' },
		{ correto: 'Europark', base: 'Europark' },
		{ correto: 'Mirante', base: 'Mirante' },
		{ correto: 'panificadora', base: 'panificadora' },
